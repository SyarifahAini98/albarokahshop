            ...
            <div class="row">
                ...
                <!-- /.row -->
                    <div class="row">
                        ...
                        <div class="btn-group alg-right-pad">
                            ...
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a href="harga_terendah_alat_musik.php">Harga Terendah</a></li>
                                    <li class="divider"></li>
                                    <li><a href="harga_tertinggi_alat_musik.php">Harga Tertinggi</a></li>
                                    <li class="divider"></li>
                                    <li><a href="produk_populer_alat_musik.php">Populer</a></li>
                                </ul>
                            </div>
                        </div>
                        <br><br><br>
                        ...
                        $sql = "SELECT * FROM produk WHERE nama_produk LIKE '%$q%' AND kategori='Alat Musik' ORDER BY harga_produk DESC"; // query silahkan disesuaikan
