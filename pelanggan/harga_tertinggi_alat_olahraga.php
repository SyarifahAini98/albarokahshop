        ...
        <div class="container" style='width:50%; float: left; width: 50%; margin-left:0px; margin-right:0px; margin-top: 65px;"'>
            <div class="row">
                ...
                <!-- /.row -->
                    <div class="row">
                        <?php
                        $query = "SELECT COUNT(*) as total FROM produk WHERE kategori='Alat Olahraga'";
                        ...
                        <div class="btn-group alg-right-pad">
                            ...
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a href="harga_terendah_alat_olahraga.php">Harga Terendah</a></li>
                                    <li class="divider"></li>
                                    <li><a href="harga_tertinggi_alat_olahraga.php">Harga Tertinggi</a></li>
                                    <li class="divider"></li>
                                    <li><a href="produk_populer_alat_olahraga.php">Populer</a></li>
                                </ul>
                            </div>
                        </div>
                        <br><br><br>
                        ...
                        $sql = "SELECT * FROM produk WHERE nama_produk LIKE '%$q%' AND kategori='Alat Olahraga' ORDER BY harga_produk DESC"; // query silahkan disesuaikan
